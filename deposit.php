...
<title>Deposit Dana Taruhan88 - Agen Bola | Judi bola | Bandar Bola | Judi Online Terpercaya</title>
<meta name="author" content="taruhan88.com" />
<meta name="google-site-verification" content="" />
<meta name="description" content="Deposit dana pada Agen Bola, Judi Bola, Bandar Bola, Judi Online Terpercaya dengan proses Cepat dan juga Aman." />
...
<?php include ("loaddata.php"); ?>
	...
	<div class="wrap">
    	<table width="100%" cellpadding="0" cellpadding="0">
			...
			<form action="s_deposit.php" method="POST" class="customClass2" style="width:100%">
			<table border="0" width="100%" cellpadding="5" bgcolor="#000000" cellspacing="5" align="center">
				<tr>
				<td>
			<p align="center"><font size="5" color="#FFD700" >&nbsp;FORM DEPOSIT</font></p>
			<hr />
			...
			<tr>
				...
				<td><font face="Arial, Helvetica, sans-serif" style="font-weight:normal">:</font></td>
			...
			<tr>
				<td height="35" align="left" style="color: #FFFFFF" valign="top"><font face="Arial, Helvetica, sans-serif" style="font-weight:normal">Nomor Rekening</font></td>
				<td valign="top"><font face="Arial, Helvetica, sans-serif" style="font-weight:normal">:</font></td>
			...
			<tr>
				<td height="25" align="left" style="color: #FFFFFF"><font face="Arial, Helvetica, sans-serif" style="font-weight:normal">Jumlah Deposit</font></td>
				<td><font face="Arial, Helvetica, sans-serif" style="font-weight:normal">:</font></td>
				<td align="right"><input name="jumlah" value="0" style="text-align:right" size="32" maxlength="100" type="text" /></td></tr>
			<tr>
			...
			<tr>
				...
				<td><font face="Arial, Helvetica, sans-serif" style="font-weight:normal">:</font></td>
				<td align="right" valign="bottom"><input name="security_code" value="" size="32" maxlength="100" type="text" /></td>
			</tr>
								</table>
					</td>
					</tr>
				...
				<input value="DEPOSIT" size="25" style="font-weight:bold" type="image" src="images/deposit.png" width="427" height="50" />
			        </td>
                       </tr>
		</table>
	</form>
